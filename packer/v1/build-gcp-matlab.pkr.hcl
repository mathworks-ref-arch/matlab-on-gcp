...
source "googlecompute" "Image_Builder" {
  ...
  disk_size               = "128"
  # Full-product MATLAB images take significantly longer than the default timeout.
  # Increase state_timeout from the default 5m to avoid build failures.
  state_timeout           = "45m"
